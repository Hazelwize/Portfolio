...
const Main = ({color, border, showSlider, setShowSlider}) => {
    return (
        <div className="backGrid-1">
			...
			<section style={{borderColor: color.border}}className="flex grid-1">
				<section style={{borderColor: color.border, backgroundColor: color.section , borderRadius: `${border}%` }} className="block-1 ">
